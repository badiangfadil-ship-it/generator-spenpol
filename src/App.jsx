...
Anda adalah seorang Ahli Kurikulum Merdeka yang merancang Modul Ajar Presisi Berorientasi Deep Learning (Mindful, Meaningful, Joyful) sesuai panduan resmi Kemendikbudristek.

Buat dokumen MODUL AJAR yang komprehensif mengikuti format visual, tabel, struktur, dan urutan persis seperti instruksi di bawah ini. JANGAN buat format tersendiri.

Mata Pelajaran: ${d.mapel}
Fase / Kelas: ${d.fase}
Semester: ${d.semester}
Materi Pokok / Tema: ${tpObj.materi}
...
INFORMASI DETIL SESI INI:
Modul ini dirancang khusus untuk: **Pertemuan Ke-${tpObj.startMeeting} sampai Pertemuan Ke-${tpObj.endMeeting}** (Total ${tpObj.pertemuanCount} Pertemuan).
Alokasi Waktu Sesi Ini: ${tpObj.pertemuanCount} Pertemuan x ${d.jpPertemuan}.

STRUKTUR DOKUMEN MODUL AJAR HTML WAJIB (Ikuti Penomoran Romawi dan Abjad Persis seperti di bawah):

--- HALAMAN 1 ---
<h2 style="text-align: center; color: #1a3a5c;">MODUL AJAR KURIKULUM MERDEKA</h2>
<h3 style="text-align: center; color: #1a3a5c; margin-bottom: 20px;">${d.mapel.toUpperCase()} - FASE ${d.fase.split(' / ')[0].toUpperCase()}</h3>

<h4 style="color: #1a3a5c; border-bottom: 2px solid #1a3a5c; padding-bottom: 5px;">I. INFORMASI UMUM</h4>

<strong>A. Identitas Modul</strong>
<table style="width: 100%; border-collapse: collapse; margin-top: 10px; margin-bottom: 15px;" border="1">
  <tr>
    <td style="width: 30%; font-weight: bold; padding: 6px; background-color: #f2f2f2;">Nama Penyusun</td>
    <td style="padding: 6px;">${d.guru}</td>
  </tr>
  <tr>
    <td style="font-weight: bold; padding: 6px; background-color: #f2f2f2;">Instansi / Sekolah</td>
    <td style="padding: 6px;">${d.sekolah}</td>
  </tr>
  <tr>
    <td style="font-weight: bold; padding: 6px; background-color: #f2f2f2;">Tahun Penyusunan</td>
    <td style="padding: 6px;">${d.tahun.split('/')[0]}</td>
  </tr>
  <tr>
    <td style="font-weight: bold; padding: 6px; background-color: #f2f2f2;">Jenjang Sekolah</td>
    <td style="padding: 6px;">SMP</td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="font-weight: bold; padding: 6px; background-color: #f2f2f2;">Fase / Kelas</td>
    <td style="padding: 6px;">${d.fase.split(' / ')[0]} / ${d.fase.split(' / ')[1]}</td>
  </tr>
  <tr>
    <td style="font-weight: bold; padding: 6px; background-color: #f2f2f2;">Bab / Tema / Topik</td>
    <td style="padding: 6px;">${tpObj.materi}</td>
  </tr>
  <tr>
    <td style="font-weight: bold; padding: 6px; background-color: #f2f2f2;">Alokasi Waktu Sesi Ini</td>
    <td style="padding: 6px;">${tpObj.pertemuanCount} Pertemuan x ${d.jpPertemuan} (Pertemuan Ke-${tpObj.startMeeting} - Ke-${tpObj.endMeeting})</td>
  </tr>
</table>

<strong>B. Kompetensi Awal</strong>
<p style="margin-top: 5px; margin-bottom: 15px;">Tuliskan pengetahuan dasar dan prasyarat operasional yang harus dimiliki peserta didik sebelum menelaah topik ${tpObj.materi}.</p>

<strong>C. Profil Pelajar Pancasila (PPP)</strong>
<p style="margin-top: 5px; margin-bottom: 15px;">Uraikan minimal 2-3 dimensi (misal: Bernalar Kritis, Gotong Royong, Kreatif) beserta rincian aktivitas kontekstual dalam modul ini yang mencerminkan profil tersebut.</p>

<strong>D. Sarana dan Prasarana</strong>
<ul style="margin-top: 5px; margin-bottom: 15px;">
  <li><strong>Media:</strong> LCD Proyektor, laptop, internet, video pembelajaran, bahan tayang presentasi.</li>
  <li><strong>Alat dan Bahan:</strong> Kertas plano, spidol warna, LKPD cetak untuk diskusi.</li>
  <li><strong>Sumber Belajar:</strong> Buku Paket Siswa & Buku Guru Kemendikbudristek, serta artikel pendukung online.</li>
</ul>

<strong>E. Target Peserta Didik</strong>
<p style="margin-top: 5px; margin-bottom: 15px;">Peserta didik reguler/tipikal (umum), tidak memiliki kesulitan belajar yang spesifik.</p>

<strong>F. Model Pembelajaran</strong>
<ul style="margin-top: 5px; margin-bottom: 25px;">
  <li><strong>Moda Pembelajaran:</strong> Tatap Muka (Luring)</li>
  <li><strong>Model Pembelajaran:</strong> ${d.modelPembelajaran}</li>
</ul>

<div style="page-break-before: always;"></div>
--- HALAMAN 2 ---
<h4 style="color: #1a3a5c; border-bottom: 2px solid #1a3a5c; padding-bottom: 5px;">II. KOMPONEN INTI</h4>

<strong>A. Tujuan Pembelajaran (TP)</strong>
<ol style="margin-top: 5px; margin-bottom: 15px;">
  <li>Menyebutkan dan memahami konsep-konsep pokok mengenai ${tpObj.materi} secara kritis.</li>
  <li>(Uraikan 2-3 TP turunan spesifik yang bermuara pada: ${tpObj.tujuan})</li>
</ol>

<strong>B. Kriteria Ketercapaian Tujuan Pembelajaran (KKTP)</strong>
<ul style="margin-top: 5px; margin-bottom: 15px;">
  <li>Indikator 1: Murid mampu merumuskan keterkaitan fenomena ${tpObj.materi} dengan kehidupan sehari-hari.</li>
  <li>Indikator 2: Murid mampu menyajikan laporan analisis/produk kelompok secara kolaboratif.</li>
</ul>

<strong>C. Pemahaman Bermakna</strong>
<p style="margin-top: 5px; margin-bottom: 15px;">(Tuliskan esensi pembelajaran ini yang membawa kegunaan bagi siswa dalam merespons realitas sosial di lingkungannya.)</p>

<strong>D. Pertanyaan Pemantik</strong>
<ul style="margin-top: 5px; margin-bottom: 15px;">
  <li>(Sajikan minimal 3 pertanyaan pemantik bernalar tinggi untuk memicu rasa ingin tahu siswa.)</li>
</ul>

<strong>E. Kegiatan Pembelajaran</strong>
<p style="margin-bottom: 15px;">Berikut adalah rancangan detail Kegiatan Pembelajaran untuk <strong>Pertemuan Ke-${tpObj.startMeeting} sampai Ke-${tpObj.endMeeting}</strong>:</p>

${Array.from({ length: tpObj.pertemuanCount }).map((_, index) => {
  const meetingNum = tpObj.startMeeting + index;
  return `
  <div style="border: 1px solid #1a3a5c; padding: 15px; margin-bottom: 20px; border-radius: 6px; page-break-inside: avoid;">
    <h4 style="color: #1a3a5c; margin-top: 0; border-bottom: 1px solid #ddd; padding-bottom: 5px;">Pertemuan Ke-${meetingNum} (${d.jpPertemuan})</h4>
    
    <p><strong>1. Kegiatan Pendahuluan (15 Menit)</strong></p>
    <ul style="margin-top: 5px; margin-bottom: 10px; font-size: 10.5pt;">
      <li>Guru membuka pembelajaran dengan salam hangat, doa khusyuk, dan memeriksa kehadiran siswa.</li>
      <li>Apersepsi: Mengaitkan pelajaran dengan isu riil di sekitar atau mereview pemahaman awal murid.</li>
      <li>Motivasi: Menyampaikan tujuan pembelajaran yang akan dicapai serta pertanyaan pemantik yang menggugah logika.</li>
    </ul>

    <p><strong>2. Kegiatan Inti (50 Menit)</strong></p>
    <p style="font-size: 10.5pt;">Sintaks Model Pembelajaran <strong>${d.modelPembelajaran}</strong>:</p>
    <ul style="margin-top: 5px; margin-bottom: 10px; font-size: 10.5pt;">
      <li><strong>Orientasi Masalah:</strong> Guru menayangkan infografis atau cuplikan kasus terbaru mengenai ${tpObj.materi}.</li>
      <li><strong>Mengorganisasikan Belajar:</strong> Murid dibagi menjadi kelompok heterogen (3-4 siswa) dan dibagikan LKPD diskusi kelompok (Diferensiasi Proses).</li>
      <li><strong>Membimbing Penyelidikan:</strong> Kelompok berdiskusi mencari data di internet atau buku pegangan mengenai persoalan (Diferensiasi Konten).</li>
      <li><strong>Menyajikan Hasil Karya:</strong> Setiap kelompok menyusun peta pikiran atau kertas kerja solusi terkait materi (Diferensiasi Produk).</li>
      <li><strong>Menganalisis & Mengevaluasi:</strong> Sesi presentasi interaktif dan apresiasi bersama dari seluruh kelas.</li>
    </ul>

    <p><strong>3. Kegiatan Penutup (15 Menit)</strong></p>
    <ul style="margin-top: 5px; margin-bottom: 10px; font-size: 10.5pt;">
      <li>Peserta didik bersama guru merangkum benang merah materi ${tpObj.materi} hari ini.</li>
      <li>Guru melaksanakan refleksi singkat mengenai proses belajar ("Bagian mana yang paling kamu nikmati?").</li>
      <li>Pemberian kuis formatif akhir, penyampaian rencana materi pertemuan berikutnya, ditutup doa dan salam penutup.</li>
    </ul>
  </div>
  `;
}).join('\n')}
...
<div style="page-break-before: always;"></div>
--- HALAMAN 3 ---
<strong>F. Asesmen</strong>
<ul style="margin-top: 5px; margin-bottom: 15px;">
  <li><strong>Asesmen Sebelum Pembelajaran (Diagnostik):</strong> Non-kognitif (observasi emosi/gaya belajar) dan Kognitif prasyarat.</li>
  <li><strong>Asesmen Selama Proses (Formatif):</strong> Lembar pengamatan kinerja diskusi, penilaian presentasi, dan penilaian sikap harian.</li>
  <li><strong>Asesmen Akhir Proses (Sumatif):</strong> Tes pilihan ganda/esai serta rubrik penilaian hasil produk portofolio/laporan kelompok.</li>
</ul>

<strong>G. Pengayaan dan Remedial</strong>
<ul style="margin-top: 5px; margin-bottom: 15px;">
  <li><strong>Pengayaan:</strong> Diberikan penugasan artikel ilmiah populer atau studi kasus tingkat lanjut untuk murid berpencapaian tinggi.</li>
  <li><strong>Remedial:</strong> Pembelajaran tutor sebaya atau pendampingan terfokus ulang dari guru pada aspek yang belum dikuasai siswa.</li>
</ul>

<strong>H. Refleksi Peserta Didik dan Guru</strong>
<p style="margin-top: 5px; margin-bottom: 25px;">Refleksi Guru mengacu pada keefektifan sintaks ${d.modelPembelajaran}, sedangkan refleksi murid mengukur kemandirian serta kepuasan belajar mereka.</p>

<div style="page-break-before: always;"></div>
--- HALAMAN 4 ---
<h4 style="color: #1a3a5c; border-bottom: 2px solid #1a3a5c; padding-bottom: 5px;">III. LAMPIRAN</h4>

<div style="background-color: #f7fafc; border: 1.5px solid #cbd5e0; border-radius: 8px; padding: 20px; margin-bottom: 20px;">
  <h4 style="text-align: center; color: #1a3a5c; margin-top: 0; margin-bottom: 15px;">LEMBAR KERJA PESERTA DIDIK (LKPD)</h4>
  
  <table border="0" style="width: 100%; border: none; margin-bottom: 15px;">
    <tr>
      <td style="border: none; padding: 4px; font-weight: bold;">Kelompok: .....................................</td>
      <td style="border: none; padding: 4px; text-align: right; font-weight: bold;">Hari/Tanggal: .....................................</td>
    </tr>
    <tr>
      <td style="border: none; padding: 4px;">Nama Anggota: <br>1. ............................................ <br>2. ............................................</td>
      <td style="border: none; padding: 4px; text-align: right; vertical-align: top;">Kelas/Smt: ${d.fase.split(' / ')[1]} / Semester ${d.semester}</td>
    </tr>
  </table>

  <div style="background-color: #ebf8ff; border: 1px solid #bee3f8; border-radius: 6px; padding: 12px; margin-bottom: 15px;">
    <span style="font-weight: bold; color: #2b6cb0;">STUDI KASUS KONTEMPORER: ISU TERKAIT ${tpObj.materi.toUpperCase()}</span>
    <p style="font-size: 10pt; line-height: 1.5; color: #2d3748; margin-top: 5px; margin-bottom: 0;">(Sajikan 2 paragraf artikel pemantik yang sangat relevan dan menarik untuk didiskusikan oleh murid terkait topik ${tpObj.materi}.)</p>
  </div>

  <p><strong>Ayo Diskusikan & Selesaikan Permasalahan Berikut:</strong></p>
  <p>1. Kemukakan permasalahan utama yang terjadi di dalam bacaan studi kasus di atas!</p>
  <p style="color: #a0aec0; font-style: italic;">Jawab: .........................................................................................................................................................</p>
  
  <p>2. Jelaskan faktor-faktor yang mendorong terjadinya permasalahan tersebut!</p>
  <p style="color: #a0aec0; font-style: italic;">Jawab: .........................................................................................................................................................</p>
  
  <p>3. Rancanglah solusi alternatif kreatif yang dapat kelompok Anda tawarkan!</p>
  <p style="color: #a0aec0; font-style: italic;">Jawab: .........................................................................................................................................................</p>
</div>

<strong>Bahan Bacaan Guru & Peserta Didik</strong>
<p style="margin-top: 5px; margin-bottom: 15px;">(Sajikan ringkasan materi ${tpObj.materi} yang informatif, akurat, dan komprehensif agar siswa memiliki rujukan belajar yang valid.)</p>

<strong>Glosarium</strong>
<p style="margin-top: 5px; margin-bottom: 15px;">Sebutkan istilah ilmiah kunci beserta artinya yang relevan dengan topik ini.</p>

<strong>Daftar Pustaka</strong>
<p style="margin-top: 5px; margin-bottom: 25px;">(Tuliskan rujukan buku paket utama Kurikulum Merdeka atau website penunjang berformat APA.)</p>
