...
function Dashboard({ onLogout }) {
  ...
  const [appData, setAppData] = useState({
    ...
    elemenList: 'Tuliskan Elemen CP disini dan buatkan singkatan, Contoh: | PK | Pemahaman Konsep | KP | Keterampilan Proses dst...',
    cpUmum: 'Tuliskan/Copy Paste Capaian Pembelajaran (CP) Umum (Rasional Mapel) secara lengkap dikolom ini',
    cpElemen: 'Tuliskan/Copy Paste Capaian Pembelajaran (CP) Per Elemen secara lengkap dikolom ini',
